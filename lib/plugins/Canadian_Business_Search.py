...
import os, logging, requests, datetime, json, urllib.parse, plugins.common.General as General
    ...
    for Query in Query_List:
        ...
        if Type == "CBN":
            ...
            try:
                ...
                logging.info(str(datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')) + " Invalid query provided for CCN Search.")

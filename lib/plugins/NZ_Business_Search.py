...
import os, re, logging, requests, datetime, urllib.parse, plugins.common.General as General
    ...
    for Query in Query_List:
        ...
        if Type == "NZBN":
            ...
            try:
                ...
                logging.info(str(datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')) + " Invalid query provided for NZBN Search.")
            ...
            try:
                ...
                logging.info(str(datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')) + " Invalid query provided for NZCN Search.")
